            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">								
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @forelse ($supply as $suppliers)

                            <tr>
                                <td>{{ $suppliers->id }}</td>
                                <td><a href="#">{{ $suppliers->name }}</a></td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('suppliers.destroy', $suppliers->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Do you want to delete this product?')">
                                        @csrf
