...
<section class="section-3 py-5">
    <div class="container">
        <div class="tieude">
            <a href="/">Trang chủ</a>
            <span>&nbsp;&nbsp;/&nbsp;&nbsp;</span>
            <a href="" style="color: black">Ngũ cốc giảm cân</a> <!-- Hiển thị tên category -->
        </div>
        <div class="package-title text-center mb-4">NGŨ CỐC ĂN GIẢM CĂN</div>
        <div class="row">
            @foreach($cerealPackages as $category)
            <div class="col-md-4">
